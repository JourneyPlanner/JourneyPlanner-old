...
<template>
  ...
  <div class="font-nunito-sans text-text-black ml-5 mt-10 mr-1 sm:ml-20 sm:mr-10 lg:mx-60">
    ...
    <p class="font-nunito-sans text-base">
      ...
      allein oder gemeinsam mit anderen über die Zwecke und Mittel der Verarbeitung entscheiden. Zudem informieren wir
      Sie nachfolgend über die von uns zu Optimierungszwecken sowie zur Steigerung der Nutzungsqualität eingesetzten
      Fremdkomponenten, soweit hierdurch Dritte Daten in wiederum eigener Verantwortung verarbeiten.
    </p>
    <br>

    <p class="font-nunito-sans text-base">Unsere Datenschutzerklärung ist wie folgt gegliedert:</p>
    <p class="font-nunito-sans font-semibold text-base">
    ...
    <p class="font-nunito-sans text-base">
      ...
      Verarbeitung, die aufgrund der Artikel 16, 17 Abs. 1, 18 DSGVO erfolgt, zu unterrichten. Diese Verpflichtung besteht jedoch
      nicht, soweit diese Mitteilung unmöglich oder mit einem unverhältnismäßigen Aufwand verbunden ist. Unbeschadet dessen hat
    ...
    <p class="font-nunito-sans text-base">
      ...
      f) DSGVO verarbeitet werden. Insbesondere ist ein Widerspruch gegen die Datenverarbeitung zum Zwecke der Direktwerbung
      statthaft.
      </strong>
    </p>
    <br>
    ...
    <p class="font-nunito-sans text-base">
      ...
      oder gesperrt, sobald der Zweck der Speicherung entfällt, der Löschung der Daten keine gesetzlichen
    ...
    <p class="font-nunito-sans text-base">
      ...
      Maßnahmen oder der Vertragserfüllung dient, so ist Rechtsgrundlage für diese Verarbeitung auch
    ...
    <p class="font-nunito-sans text-base">Wir bieten Ihnen an, auf unseren Internetseiten Fragen, Antworten, Meinungen
      ...
      Ihnen ggf. genutzte Pseudonym.
    </p>
    <p class="font-nunito-sans text-base">
      Rechtsgrundlage hierbei ist Art. 6 Abs. 1 lit. a) DSGVO. Die Einwilligung können Sie gemäß Art. 7 Abs. 3 DSGVO
      jederzeit mit Wirkung für die Zukunft widerrufen. Hierzu müssen Sie uns lediglich über Ihren Widerruf in Kenntnis
      setzen.
    </p>
    <p class="font-nunito-sans text-base">
      Darüber hinaus verarbeiten wir auch Ihre IP- und E-Mail-Adresse. Die IP-Adresse wird verarbeitet, weil wir ein
      berechtigtes Interesse daran haben, weitere Schritte einzuleiten oder zu unterstützen, sofern Ihr Beitrag in
      Rechte Dritter eingreift und/oder er sonst wie rechtswidrig erfolgt.
    </p>
    <p class="font-nunito-sans text-base">
    ...
    <p class="font-nunito-sans text-base">
      ...
      übermittelt. Mit diesen sog. Server-Logfiles werden u.a. Typ und Version Ihres Internetbrowsers,
      das Betriebssystem, die Website, von der aus Sie auf unseren Internetauftritt gewechselt haben (Referrer URL),
      die Website(s) unseres Internetauftritts, die Sie besuchen, Datum und Uhrzeit des jeweiligen Zugriffs sowie die
      IP-Adresse des Internetanschlusses, von dem aus die Nutzung unseres Internetauftritts erfolgt, erhoben.
    </p>
    <p class="font-nunito-sans text-base">
    ...
    <p class="font-nunito-sans text-base">
      Rechtsgrundlage ist Art. 6 Abs. 1 lit. f) DSGVO. Unser berechtigtes Interesse liegt in dem sicheren Betrieb unseres
      Internetauftritts sowie in dessen Optimierung.
    </p>
    <p class="font-nunito-sans text-base">
      Sofern Sie unseren Internetauftritt aufrufen, werden Ihre Anfragen über den Server von CloudFlare geleitet. Hierbei
      werden statistische Zugriffsdaten über den Besuch unseres Internetauftritts erhoben und durch CloudFlare ein
      Cookie über Ihren Internet-Browser auf Ihrem Endgerät gespeichert. Zu den Zugriffsdaten zählen
    </p>
    <p class="font-nunito-sans text-base">– Ihre IP-Adresse,</p>
    <p class="font-nunito-sans text-base">– die von Ihnen aufgerufene(n) Internetseite(n) unseres Internetauftritts,</p>
    <p class="font-nunito-sans text-base">– Typ und Version des von Ihnen genutzten Internet – Browsers,</p>
    <p class="font-nunito-sans text-base">– das von Ihnen genutzte Betriebssystem,</p>
    <p class="font-nunito-sans text-base">– die Internetseite, von der sie auf unseren Internetauftritt gewechselt haben
      (Referrer- URL),</p>
    <p class="font-nunito-sans text-base">– Ihre Verweildauer auf unserem Internetauftritt und</p>
    <p class="font-nunito-sans text-base">– die Häufigkeit des Aufrufs unserer Internetseiten.</p>
    <p class="font-nunito-sans text-base">
      Die Daten werden durch CloudFlare zum Zwecke statistischer Auswertungen der
      Zugriffe sowie zur Sicherheit und
    ...
    <p class="font-nunito-sans text-base">
      ...
      Cookies durch die entsprechenden Einstellungen in Ihrem Internet-Browser zu verhindern. Einzelheiten hierzu finden
      Sie vorstehend unter dem Punkt „Cookies“.
    </p>
    <p class="font-nunito-sans text-base">CloudFlare bietet unter</p>
    <p class="font-nunito-sans text-base">
    ...
    <p class="font-nunito-sans text-base">
      Bei Aufruf einer unserer Internetseiten, in die der Dienst OpenStreetMap eingebunden ist, wird durch OpenStreetMap
      ein Cookie über Ihren Internet-Browser auf Ihrem Endgerät gespeichert. Hierdurch werden Ihre Nutzereinstellungen
      und Nutzerdaten zum Zwecke der Anzeige der Seite bzw. zur Gewährleistung der Funktionalität des Dienstes OpenStreetMap
      verarbeitet. Durch diese Verarbeitung kann OpenStreetMap erkennen, von welcher Internetseite Ihre Anfrage gesendet
      worden ist und an welche IP- Adresse die Darstellung der Anfahrt übermittelt werden soll.
    </p>
    <p class="font-nunito-sans text-base">
      Im Falle einer von Ihnen erteilten Einwilligung für diese Verarbeitung ist Rechtsgrundlage Art. 6 Abs. 1 lit. a
      DSGVO. Rechtsgrundlage kann auch Art. 6 Abs. 1 lit. f DSGVO sein. Unser berechtigtes Interesse liegt in der
    ...
    <p class="font-nunito-sans text-base">OpenStreetMap bietet unter</p>
    <p class="font-nunito-sans text-base">
      <a href="https://wiki.osmfoundation.org/wiki/Privacy_Policy" target="_blank"
                                             rel="noopener nofollow">https://wiki.osmfoundation.org/wiki/Privacy_Policy</a>
    </p>
    <p class="font-nunito-sans text-base">
      weitere Informationen zur Erhebung und Nutzung der Daten sowie zu Ihren Rechten und Möglichkeiten zum Schutz Ihrer
      Privatsphäre an.
    </p>
    <br>
    <p class="font-nunito-sans text-base font-light">
