...
<template>
  <h2 class="font-nunito font-bold text-3xl text-center">Impressum</h2>
  <div class="ml-20 mr-20 mt-2 ">
    ...
    <p><b>Online Streitbeilegung:</b> Verbraucher, welche in Österreich oder in einem sonstigen Vertragsstaat der ODR-VO
      niedergelassen sind, haben die Möglichkeit Probleme bezüglich dem entgeltlichen Kauf von Waren oder Dienstleistungen
    ...
    <p><b>Haftungsausschluss:</b> Trotz sorgfältiger inhaltlicher Kontrolle übernimmt der Webseitenbetreiber dieser
      ...
      deren Betreiber verantwortlich. Sollten Sie dennoch auf ausgehende Links aufmerksam werden, welche auf eine Webseite
      mit rechtswidriger Tätigkeit/Information verweisen, ersuchen wir um dementsprechenden Hinweis, um diese nach § 17
      ...
      entsprechenden Hinweis. Bei Bekanntwerden derartiger Rechtsverletzungen werden wir den betroffenen Inhalt umgehend
      entfernen.</p>
    ...
    <p>Quelle: <b><a href="https://www.rechtstexte-generator.at/dsgvo-generator-oesterreich/">Datenschutz DSGVO
      Generator</a></b> in Kooperation mit <br><b><a
        href="https://www.ortner-rechtsanwalt.at/rechtsanwalt-fuer-arbeitsrecht//">Rechtsanwalt Arbeitsrecht</a></b></p>
  </div>
</template>
